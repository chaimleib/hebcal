...
extern int ashkenazis_sw, dafYomi_sw, utf8_hebrew_sw, candleLighting_sw,
    gregDateOutputFormatCode_sw, hebrewDates_sw, inputFile_sw, israel_sw, latdeg, latmin,
    latsec, longdeg, longmin, longsec, latlong_sw, printOmer_sw, printHebDates_sw,
    printSomeHebDates_sw, printMolad_sw, printSunriseSunset_sw, sedraAllWeek_sw,
    sedrot_sw, noGreg_sw, noHolidays_sw, suppress_rosh_chodesh_sw, suppressModern_sw,
    tabs_sw, weekday_sw, abbrev_sw, yearDigits_sw, yahrtzeitFile_sw, default_zemanim;
extern int twentyFourHour_sw;

extern timelib_tzinfo *TZ_INFO;

extern int havdalah_minutes, light_offset;
